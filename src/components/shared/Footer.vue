        ...
        <div class="footer footer1">
                    ...
                    <div class="row">
                            ...
                            <div class="item-service-footer">
                                <div class="service-icon">
                                    <a href="#" class="wobble-horizontal">
                                        <img class="img-circle" src="./../../assets/images/photos/piggy-bank.png" alt="" />
                                    </a>
                                </div>
                                <div class="service-info">
                                    ...
                                    <ul class="list-unstyled">
                                        <li>
                                            <a href="#">Display your verification status</a>
                                        </li>
                                        <li>
                                            <a href="#">Faster responses from suppliers when verified</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="item-service-footer">
                                <div class="service-icon">
                                    <a href="#" class="wobble-horizontal">
                                        <img class="img-circle" src="./../../assets/images/photos/investment.png" alt="" />
                                    </a>
                                </div>
                                <div class="service-info">
                                    ...
                                    <ul class="list-unstyled">
                                        <li>
                                            <a href="#">Trusted local lenders</a>
                                        </li>
                                        <li>
                                            <a href="#">Trade financing in minutes</a>
                                        </li>
                                        <li>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="item-service-footer">
                                <div class="service-icon">
                                    <a href="#" class="wobble-horizontal">
                                        <img class="img-circle" src="./../../assets/images/photos/telemarketer.png" alt="" />
                                    </a>
                                </div>
                                <div class="service-info">
                                    ...
                                    <ul class="list-unstyled">
                                        <li>
                                            <a href="#">Independent inspectors</a>
                                        </li>
                                        <li>
                                            <a href="#">Proven cost efficiency</a>
                                        </li>
                                        <li>
                                            <a href="#">Competitive rates</a>
                                        </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="contact-footer-box footer-box">
                                ...
                                <p class="formule-phone">+1 800 559 6580
                                    <br>+1 504 889 9898</p>
                                <p class="formule-email">
                                    <a href="mailto:email@demolink.org">email@demolink.org</a>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="payment-method text-center">
                <a href="#" class="wobble-vertical">
                    <img src="./../../assets/images/home4/pay1.png" alt="" />
                </a>
                <a href="#" class="wobble-vertical">
                    <img src="./../../assets/images/home4/pay2.png" alt="" />
                </a>
                <a href="#" class="wobble-vertical">
                    <img src="./../../assets/images/home4/pay3.png" alt="" />
                </a>
                <a href="#" class="wobble-vertical">
                    <img src="./../../assets/images/home4/pay4.png" alt="" />
                </a>
            </div>
            <!-- End Payment -->
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="item-tag-footer">
                                <div class="title-tag-footer">
                                    <span style="width:130px">Beaty &amp; Health:</span>
                                </div>
                            ...
                            <div class="item-tag-footer">
                                <div class="title-tag-footer">
                                    <span style="width:130px">electronics:</span>
                                </div>
                                <div class="list-tag-footer">
                                    <a href="#">LED TV </a>
                                    <a href="#">Speakers </a>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="item-tag-footer">
                                <div class="title-tag-footer">
                                    <span style="width:80px">sports:</span>
                                </div>
                                <div class="list-tag-footer">
                                    <a href="#">Home Gym </a>
                            ...
                            <div class="item-tag-footer">
                                <div class="title-tag-footer">
                                    <span style="width:80px">Fashion:</span>
                                </div>
                                <div class="list-tag-footer">
                                    <a href="#">Sunglasses </a>
                                    <a href="#">Sarees </a>
            ...
            <div class="footer-copyright">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <p class="designby">Design by:
                                <a href="mailto:7uptheme.com">7uptheme.com</a>
                            </p>
                        </div>
                    </div>
                </div>
