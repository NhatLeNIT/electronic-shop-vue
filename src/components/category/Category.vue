        ...
        <div class="container">
            <div class="banner-shop">
                <div class="banner-shop-thumb">
                    <a href="#"><img src="./../../assets/images/shop/bn-grid-boxed.jpg" alt="" /></a>
                </div>
                <div class="banner-shop-info text-center">
                    <h2>Furniter style 2016</h2>
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="sidebar sidebar-left">
                        <div class="widget widget-product-cat">
                            <h2 class="widget-title title14">Fashion</h2>
                            ...
                            <div class="widget-content">
                                <div class="wrap-item" data-pagination="false" data-navigation="true" data-itemscustom="[[0,1]]">
                                    <div class="list-pro-seller">
                                        <div class="item-pro-seller">
                                            <div class="product-thumb">
                                                <a href="#" class="product-thumb-link"><img src="./../../assets/images/photos/homeware/8.jpg" alt="" /></a>
                                            </div>
                                        ...
                                        <div class="item-pro-seller">
                                            <div class="product-thumb">
                                                <a href="#" class="product-thumb-link"><img src="./../../assets/images/photos/homeware/2.jpg" alt="" /></a>
                                            </div>
                                            <div class="product-info">
                                                <h3 class="product-title"><a href="detail.html">new favorite</a></h3>
                                                <div class="product-price">
                                        ...
                                        <div class="item-pro-seller">
                                            <div class="product-thumb">
                                                <a href="#" class="product-thumb-link"><img src="./../../assets/images/photos/homeware/9.jpg" alt="" /></a>
                                            </div>
                                            <div class="product-info">
                                                <h3 class="product-title"><a href="detail.html">new favorite</a></h3>
                                                <div class="product-price">
                                    ...
                                    <div class="list-pro-seller">
                                        <div class="item-pro-seller">
                                            <div class="product-thumb">
                                                <a href="#" class="product-thumb-link"><img src="./../../assets/images/photos/homeware/3.jpg" alt="" /></a>
                                            </div>
                                            <div class="product-info">
                                                <h3 class="product-title"><a href="detail.html">new favorite</a></h3>
                                                <div class="product-price">
                                        ...
                                        <div class="item-pro-seller">
                                            <div class="product-thumb">
                                                <a href="#" class="product-thumb-link"><img src="./../../assets/images/photos/homeware/4.jpg" alt="" /></a>
                                            </div>
                                            <div class="product-info">
                                                <h3 class="product-title"><a href="detail.html">new favorite</a></h3>
                                                <div class="product-price">
                                        ...
                                        <div class="item-pro-seller">
                                            <div class="product-thumb">
                                                <a href="#" class="product-thumb-link"><img src="./../../assets/images/photos/homeware/10.jpg" alt="" /></a>
                                            </div>
                                            <div class="product-info">
                                                <h3 class="product-title"><a href="detail.html">new favorite</a></h3>
                                                <div class="product-price">
                        ...
                        <div class="widget widget-brand">
                            ...
                            <div class="widget-content">
                                <div class="item-brand-side">
                                    <div class="brand-side-thumb"><a href="#"><img class="wobble-vertical" src="./../../assets/images/photos/brands/logo1.png" alt="" /></a></div>
                                ...
                                <div class="item-brand-side">
                                    <div class="brand-side-thumb"><a href="#"><img class="wobble-vertical" src="./../../assets/images/photos/brands/logo2.png" alt="" /></a></div>
                                    <div class="brand-side-info">
                                ...
                                <div class="item-brand-side">
                                    <div class="brand-side-thumb"><a href="#"><img class="wobble-vertical" src="./../../assets/images/photos/brands/logo20.png" alt="" /></a></div>
                                    <div class="brand-side-info">
                            ...
                            <div class="row">
                                    ...
                                    <div class="item-pro-color">
                                        <div class="product-thumb">
                                            <a href="detail.html" class="product-thumb-link">
                                                <img data-color="black" class="active" src="./../../assets/images/photos/fashion/1.jpg" alt="">
                                                <img data-color="purple" src="./../../assets/images/photos/fashion/2.jpg" alt="">
                                                <img data-color="blue" src="./../../assets/images/photos/fashion/3.jpg" alt="">
                                                <img data-color="cyan" src="./../../assets/images/photos/fashion/4.jpg" alt="">
                                            </a>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    <div class="item-pro-color">
                                        <div class="product-thumb">
                                            ...
                                            <a href="detail.html" class="product-thumb-link">
                                                <img data-color="yellow" class="active" src="./../../assets/images/photos/fashion/9.jpg" alt="">
                                                <img data-color="red" src="./../../assets/images/photos/fashion/10.jpg" alt="">
                                            </a>
                                            <a href="quick-view.html" class="quickview-link plus fancybox.iframe"><span>quick view</span></a>
                                        </div>
                                        <div class="product-info">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    <div class="item-pro-color">
                                        <div class="product-thumb">
                                            <a href="detail.html" class="product-thumb-link">
                                                <img data-color="purple" class="active" src="./../../assets/images/photos/fashion/8.jpg" alt="">
                                                <img data-color="blue" src="./../../assets/images/photos/fashion/7.jpg" alt="">
                                            </a>
                                            <a href="quick-view.html" class="quickview-link plus fancybox.iframe"><span>quick view</span></a>
                                        </div>
                                        <div class="product-info">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                    <div class="item-pro-color">
                                        <div class="product-thumb">
                                            <a href="detail.html" class="product-thumb-link">
                                                <img data-color="black" class="active" src="./../../assets/images/photos/fashion/16.jpg" alt="">
                                                <img data-color="green" src="./../../assets/images/photos/fashion/15.jpg" alt="">
                                                <img data-color="blue" src="./../../assets/images/photos/fashion/14.jpg" alt="">
                                            </a>
                                            <a href="quick-view.html" class="quickview-link plus fancybox.iframe"><span>quick view</span></a>
                                        </div>
                                        <div class="product-info">
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="item-pro-color">
                                            <div class="product-thumb">
                                                <a href="detail.html" class="product-thumb-link">
                                                    <img data-color="black" src="./../../assets/images/photos/fashion/2.jpg" alt="">
                                                    <img data-color="purple" class="active" src="./../../assets/images/photos/fashion/3.jpg" alt="">
                                                    <img data-color="blue" src="./../../assets/images/photos/fashion/4.jpg" alt="">
                                                    <img data-color="cyan" src="./../../assets/images/photos/fashion/5.jpg" alt="">
                                                </a>
                                                <a href="quick-view.html" class="quickview-link plus fancybox.iframe"><span>quick view</span></a>
                                            </div>
                                            <div class="list-color">
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="item-pro-color">
                                            <div class="product-thumb">
                                                <a href="detail.html" class="product-thumb-link">
                                                    <img data-color="black" class="active" src="./../../assets/images/photos/fashion/9.jpg" alt="">
                                                    <img data-color="purple" src="./../../assets/images/photos/fashion/3.jpg" alt="">
                                                    <img data-color="blue" src="./../../assets/images/photos/fashion/4.jpg" alt="">
                                                    <img data-color="cyan" src="./../../assets/images/photos/fashion/5.jpg" alt="">
                                                </a>
                                                <a href="quick-view.html" class="quickview-link plus fancybox.iframe"><span>quick view</span></a>
